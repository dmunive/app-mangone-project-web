...
export class ListChapterComponent implements OnInit {
  ...
  public goToUpdate(chapter: IChapter): void {
    this.router.navigate([`/comics/${this.comicId}/chapters/update/${chapter._id}`]);
  }
  ...
  public goToListPage(chapter: IChapter): void {
    this.router.navigate([`/comics/${this.comicId}/chapters/${chapter._id}/pages`]);
  }
}
