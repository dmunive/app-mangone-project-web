...
export class ListComicComponent implements OnInit {
  ...
  public goToUpdate(comic: IComic): void {
    this.router.navigate([`/comics/update/${comic._id}`]);
  }
  ...
  public goToListChapter(comic: IComic): void {
    this.router.navigate([`/comics/${comic._id}/chapters`]);
  }
